...
from app.api import auth, sites, products, inventory, orders, finance, energy, alerts, market, sensor, storage, seed
...
router.include_router(seed.router, prefix="/api", tags=["seed"])  # Demo data endpoint
